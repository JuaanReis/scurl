...
from heuristics.url.typos.wordlists.wordlist_generator import domain_generator as load_domains
from heuristics.url.typos.index import build_index
from heuristics.url.typos.detect import detect
