...
from core.scanner.heuristics.url_analyzer.check.base64_detect.base64_segments import base64_segments
from core.scanner.heuristics.url_analyzer.check.parts_check import random_path_risk, query_no_value, query_contains_url, path_depth_risk, fragment_risk
