...
from core.heuristics.url_analyzer.check.typos.wordlists.wordlist_generator import domain_generator as load_domains
from core.heuristics.url_analyzer.check.typos.index import build_index
from core.heuristics.url_analyzer.check.typos.detect import detect
