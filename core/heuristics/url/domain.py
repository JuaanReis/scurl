...
from core.math.value_normalizator import minmax, normalize_counter
from .parts import looks_like_hash
from ..registry import register

@register(name="ip_in_url", category="url", severity="medium", weight=3.0, tags=["url", "ip", "bypass"])
...
@register(name="random_domain_risk", category="url", severity="medium", weight=3.0, tags=["url", "entropy", "random"])
...
@register(name="subdomain_count", category="url", severity="low", weight=2.0, tags=["url", "subdomain", "depth"])
...
@register(name="random_subdomain_risk", category="url", severity="medium", weight=3.0, tags=["url", "subdomain", "entropy"])
